...
mcmc <- list(   nskip=500,    # block size for each saved state
                nsave=2000,    # number of saved states
                npar=2,      # skips between parameter updates
                eps1=0.02,    # scale of alpha update
                eps2=0.0005  )  #  scale of beta update; reduction of sd
...
save(results, file=paste("../result/FDI_attraction_experiment",
